...
<html>
<head>
    <title>Seoul Public WiFi Hotspot Finder - Nearest 20 WiFi Hotspots</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
    <link rel="stylesheet" type="text/css"  href="<c:url value='/css/style.css' />">
</head>
<body>
<h1>Seoul Public WiFi Hotspot Finder - Result</h1>
<section>
    <div class="container">
    ...
    <div class="tbl-content">
        <table>
            <tbody>
                ...
                <tr>
                    <td>${hotspot.getStringDist()}</td>
                    <td>${hotspot.getDistrict()}</td>
                    <td>${hotspot.getAddress()}</td>
                    <td>${hotspot.getDetail()}</td>
                    <td>${hotspot.getIndoor()}</td>
                    <td>${hotspot.getLat()}</td>
                    <td>${hotspot.getLng()}</td>
                </tr>
                </c:forEach>
            </tbody>
        </table>
